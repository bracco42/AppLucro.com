...
const translations = {
  'en': {
    ...
    formula: 'Long Term Profit Formula: Revenue - Expenses (Fuel [km/mi riden based] and Others* [time spent based]) - Depreciation (3.33% * Vehicle Value per year) - Risk (10% * Insurance Premium per year). Note: short term profit only deducts ride fuel cost.',
  ...
  'fr': {
    ...
    formula: 'Formule de Bénéfice à Long Terme : Revenu - Dépenses (Carburant [basé sur les km] et Autres* [basé sur le temps]) - Dépréciation (3.33% * Valeur du Véhicule par an) - Risque (10% * Prime d\'Assurance par an). Note : le bénéfice à court terme ne déduit que le coût du carburant.',
  ...
  'pt': {
    ...
    formula: 'Fórmula do Lucro de Longo Prazo: Receita - Despesas (Combustível [com base nos km] e Outros* [com base no tempo]) - Depreciação (3.33% * Valor do Veículo por ano) - Risco (10% * Prêmio do Seguro por ano).',
