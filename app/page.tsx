...
const translations = {
  'en': {
    ...
    insurancePremium: 'Insurance Claim:',
    ...
    formula: 'Long Term Profit Formula: Revenue - Expenses (Fuel [km/mi riden based] and Others* [time spent based]) - Depreciation (3.33% x Vehicle Value per year) - Risk (10% x Insurance Claim per year). Note: short term profit only deducts ride fuel cost.',
  ...
  'fr': {
    ...
    insurancePremium: 'Demande d\'Indemnisation:',
    ...
    rideDistance: 'Distance Réelle (km) Aller/Retour:',
    ...
    formula: 'Formule de Bénéfice à Long Terme: Revenu - Dépenses (Carburant [basé sur les km] et Autres* [basé sur le temps]) - Dépréciation (3.33% x Valeur du Véhicule par an) - Risque (10% x Demande d\'Indemnisation par an). Note: le bénéfice à court terme ne déduit que le coût du carburant.',
  ...
  'pt': {
    ...
    insurancePremium: 'Sinistro do Seguro:',
    ...
    formula: 'Fórmula do Lucro de Longo Prazo: Receita - Despesas (Combustível [com base nos km] e Outros* [com base no tempo]) - Depreciação (3.33% x Valor do Veículo por ano) - Risco (10% x Sinistro do Seguro por ano). O Lucro de Curto Prazo tira só o Custo do Combustível.',
