...
const translations = {
  'pt': {
    ...
    formula: 'Fórmula do Lucro de Longo Prazo: Receita - Despesas (Combustível e Outros*) - Depreciação (3.33% * Valor do Veículo por ano) - Risco (10% * Prêmio do Seguro por ano). Obs.: lucro de curto prazo desconta somente combustível da corrida. *Outros são gastos que podem ser anuais/mensais/semanais/diarios, são ponderados pelo quanto trabalha e tempo total gasto entre uma corrida e outra',
  ...
  'en': {
    ...
    formula: 'Long Term Profit Formula: Revenue - Expenses (Fuel and Others*) - Depreciation (3.33% * Vehicle Value per year) - Risk (10% * Insurance Premium per year). Note: short term profit only deducts ride fuel cost. *Others Expenses are those that can be annual/monthly/weekly/daily, they are weighted by how much you work and total time spent between rides',
