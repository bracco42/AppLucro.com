...
export default function CalculoLucro() {
  ...
  return (
    <div style={{ textAlign: 'center', padding: '20px' }}>
      ...
      <p>
        <strong>Obs.:</strong> preencher qualquer número diferente de 0 em valor do seguro e manutenção para funcionar (incluir IPVA e demais custos dentro desses campos). O valor do veículo serve como referência, pois calculamos uma depreciação de 3,333% ao ano para o lucro de longo prazo (em caso de aluguel colocar 1 ou um outro valor baixo e usar somente os outros custos). O lucro de curto prazo desconta apenas o combustível, enquanto o de longo prazo desconta todos os outros também. Os KMs rodados por dia (útil) servem para diferir (espalhar) os custos anuais para cada corrida. Dica: 0 à esquerda é desconsiderado (pode deixar).
      </p>
    </div>
  );
}
