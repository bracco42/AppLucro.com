...
const translations = {
  ...
  'hi': {
    ...
    community: 'ओपन सोर्स समुदाय! संपर्क करें: Instagram bernard.bracco या Facebook Ehnov7id30 या Bernard Diniz Bracco! दान: PIX: 100.980.686-60',
    periodicityOptions: {
      annual: 'वार्षिक',
      monthly: 'मासिक',
      weekly: 'साप्ताहिक',
  ...
  'es': {
    ...
    community: '¡Comunidad de Código Abierto! Contacta a bernard.bracco en Instagram o Ehnov7id30 o Bernard Diniz Bracco en Facebook! Para donaciones: PIX: 100.980.686-60',
    periodicityOptions: {
      annual: 'Anual',
      monthly: 'Mensual',
      weekly: 'Semanal',
  ...
  'it': {
    ...
    community: 'Open Source! Contatta bernard.bracco su Instagram o Ehnov7id30 o Bernard Diniz Bracco su Facebook! Donazioni: PIX: 100.980.686-60',
    periodicityOptions: {
      annual: 'Annuale',
      monthly: 'Mensile',
      weekly: 'Settimanale',
  ...
  'pa': {
    ...
    community: 'ਓਪਨ ਸੋਰਸ ਕਮਿਊਨਿਟੀ! ਸੰਪਰਕ: Instagram bernard.bracco ਜਾਂ Facebook Ehnov7id30 ਜਾਂ Bernard Diniz Bracco! ਦਾਨ: PIX: 100.980.686-60',
    periodicityOptions: {
      annual: 'ਸਾਲਾਨਾ',
      monthly: 'ਮਹੀਨਾਵਾਰ',
      weekly: 'ਹਫ਼ਤਾਵਾਰ',
  ...
  'vi': {
    ...
    community: 'Cộng Đồng Mã Nguồn Mở! Liên hệ bernard.bracco trên Instagram hoặc Ehnov7id30 hoặc Bernard Diniz Bracco trên Facebook! Quyên góp: PIX: 100.980.686-60',
    periodicityOptions: {
      annual: 'Hàng Năm',
      monthly: 'Hàng Tháng',
      weekly: 'Hàng Tuần',
  ...
  'ko': {
    ...
    community: '오픈 소스 커뮤니티! 연락처: Instagram bernard.bracco 또는 Facebook Ehnov7id30 또는 Bernard Diniz Bracco! 기부: PIX: 100.980.686-60',
    periodicityOptions: {
      annual: '연간',
      monthly: '월간',
      weekly: '주간',
  ...
  'th': {
    ...
    community: 'ชุมชนโอเพนซอร์ส! ติดต่อ bernard.bracco บน Instagram หรือ Ehnov7id30 หรือ Bernard Diniz Bracco บน Facebook! การบริจาค: PIX: 100.980.686-60',
    periodicityOptions: {
      annual: 'รายปี',
      monthly: 'รายเดือน',
      weekly: 'รายสัปดาห์',
  ...
  'fa': {
    ...
    community: 'جامعه منبع باز! تماس با bernard.bracco در اینستاگرام یا Ehnov7id30 یا Bernard Diniz Bracco در فیس بوک! کمک های مالی: PIX: 100.980.686-60',
    periodicityOptions: {
      annual: 'سالانه',
      monthly: 'ماهانه',
      weekly: 'هفتگی',
  ...
  'bn': {
    ...
    community: 'ওপেন সোর্স কমিউনিটি! যোগাযোগ: Instagram bernard.bracco বা Facebook Ehnov7id30 বা Bernard Diniz Bracco! দান: PIX: 100.980.686-60',
    periodicityOptions: {
      annual: 'বার্ষিক',
      monthly: 'মাসিক',
      weekly: 'সাপ্তাহিক',
