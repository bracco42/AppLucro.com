...
const translations = {
  ...
  'es': {
    ...
    workingHours: 'Horas de conducción/día (1-16):',
    ...
    community: 'Únete a nuestra <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'fr': {
    ...
    community: 'Rejoignez notre <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'de': {
    ...
    workingHours: 'Fahrstunden/Tag (1-16):',
    ...
    community: 'Treten Sie unserer <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource-Facebook-Community</a> bei!!!',
  ...
  'it': {
    ...
    workingHours: 'Ore di guida/giorno (1-16):',
    ...
    community: 'Unisciti alla nostra <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'zh': {
    ...
    community: '加入我们的<a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'ja': {
    ...
    community: '私たちの<a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'ar': {
    ...
    workingHours: 'ساعات القيادة/يوم (1-16):',
    ...
    community: 'انضم إلى <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'ru': {
    ...
    workingHours: 'Часы вождения/день (1-16):',
    ...
    community: 'Присоединяйтесь к нашему <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'hi': {
    ...
    workingHours: 'ड्राइविंग घंटे/दिन (1-16):',
    ...
    community: 'हमारे <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'pa': {
    ...
    workingHours: 'ਡਰਾਈਵਿੰਗ ਘੰਟੇ/ਦਿਨ (1-16):',
    ...
    community: 'ਸਾਡੇ <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'bn': {
    ...
    workingHours: 'ড্রাইভিং ঘন্টা/দিন (1-16):',
    ...
    community: 'আমাদের <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'ko': {
    ...
    community: '우리의 <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'vi': {
    ...
    workingHours: 'Giờ lái xe/ngày (1-16):',
    ...
    community: 'Tham gia <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'th': {
    ...
    remove: 'ลบ',
    timeSpent: 'เวลาทำงาน:',
    workingHours: 'ชั่วโมงขับรถ/วัน (1-16):',
    ...
    community: 'เข้าร่วม <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'tr': {
    ...
    workingHours: 'Sürüş saatleri/gün (1-16):',
    ...
    community: '<a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'fa': {
    ...
    remove: 'حذف',
    timeSpent: 'زمان کار:',
    workingHours: 'ساعات رانندگی/روز (1-16):',
    ...
    community: 'به <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'uk': {
    ...
    workingHours: 'Години керування/день (1-16):',
    ...
    community: 'Приєднуйтесь до нашої <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'sw': {
    ...
    workingHours: 'Saa za kuendesha/siku (1-16):',
    ...
    community: 'Jiunge na <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
  ...
  'da': {
    ...
    workingHours: 'Køretimer/dag (1-16):',
    ...
    community: 'Tilmeld dig vores <a href="https://www.facebook.com/groups/1587875928477657" target="_blank" style="color: #0f0; text-decoration: underline;">OpenSource Facebook Community</a>!!!',
