...
const translations = {
  ...
  'fr': {
    ...
    insurancePremium: 'Demande de Indemnisation:',
    ...
    formula: 'Formule de Bénéfice à Long Terme: Revenu - Dépenses (Carburant [basé sur les km] et Autres* [basé sur le temps]) - Dépréciation (3.33% x Valeur du Véhicule par an) - Risque (10% x Prime d\'Assurance par an). Note: le bénéfice à court terme ne déduit que le coût du carburant.',
  ...
  'pt': {
    ...
    formula: 'Fórmula do Lucro de Longo Prazo: Receita - Despesas (Combustível [com base nos km] e Outros* [com base no tempo]) - Depreciação (3.33% x Valor do Veículo por ano) - Risco (10% x Prêmio do Seguro por ano). O Lucro de Curto Prazo tira só o Custo do Combustível.',
