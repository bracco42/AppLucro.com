...
const translations = {
  ...
  'pt': {
    ...
    formula: 'Fórmula do Lucro de Longo Prazo: Receita - Despesas (Combustível [com base nos km] e Outros* [com base no tempo]) - Depreciação (3.33% x Valor do Veículo por ano) - Risco (10% x Prêmio do Seguro por ano).',
